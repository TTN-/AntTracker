...
//======================================= LEDS, OLED SSD1306, rx pin =====================================
  ...
  #include <Servo.h>  
  uint8_t in_rxPin =        PA_3;  // rx2 Serial1
  #define in_txPin          PA_2   // tx2 Serial1
  uint8_t gps_rxPin =       PB_11;  // rx3 Serial2
  #define gps_txPin         PB_10   // tx3 Serial2
  bool rxInvert = false;           // ONLY FOR FrSky S.Port, NOT F.Port, NOT MAVLINK    
  #define SetHomePin        PA_0    
  #define StatusLed         PA_6  // Off=No good GPS yet, flashing=good GPS but home not set yet, solid = ready to track
  #define azPWM_Pin         PA_7  // azimuth servo 
  #define elPWM_Pin         PA_8  // elevation servo
  #define BuiltinLed        PC_13  
  #define SDA               PB_7  // I2C OLED board and/or Compass - default can be changed in Wire.h 
  #define SCL               PB_6  // I2C OLED board and/or Compass - default can be changed in Wire.h 
  //=========================================================================   
